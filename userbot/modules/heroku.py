...
@javes05(outgoing=True, pattern=r"^!(set|get|del) var(?: |$)(.*)(?: |$)")
...
@javes.on(admin_cmd(pattern='(set|get|del) var(?: |$)(.*)(?: |$)([\\s\\S]*)', allow_sudo=True))
async def variable(var):
    try:
       Heroku = heroku3.from_key(HEROKU_API_KEY)                         
       app = Heroku.app(HEROKU_APP_NAME)
...
@javes05(outgoing=True, pattern="^\!usage$")
async def _(dyno):        
        try:
             Heroku = heroku3.from_key(HEROKU_API_KEY)                         
             app = Heroku.app(HEROKU_APP_NAME)
...
@javes.on(admin_cmd(pattern=f"usage$", allow_sudo=True))
async def _(dyno):        
        try:
             Heroku = heroku3.from_key(HEROKU_API_KEY)                         
             app = Heroku.app(HEROKU_APP_NAME)
...
@javes.on(admin_cmd(pattern='shutdown$', allow_sudo=True))
async def _(dyno):        
    try:
               Heroku = heroku3.from_key(HEROKU_API_KEY)                         
               app = Heroku.app(HEROKU_APP_NAME)
    ...
    if not FULL_SUDO:
        ...
        while (sleep <= 3):
            ...
            dot += "."
            sleep += 1
        await dyno.respond('turned off...`')
        return await dyno.delete()        
        
        
        
@javes05(outgoing=True, pattern="^\!logs$")
async def _(dyno):        
        try:
             Heroku = heroku3.from_key(HEROKU_API_KEY)                         
             app = Heroku.app(HEROKU_APP_NAME)
...
@javes.on(admin_cmd(pattern='logs$', allow_sudo=True))
async def _(dyno):        
    try:
               Heroku = heroku3.from_key(HEROKU_API_KEY)                         
               app = Heroku.app(HEROKU_APP_NAME)
...
@javes.on(admin_cmd(pattern='restart$', allow_sudo=True))
async def _(dyno):        
    try:
               Heroku = heroku3.from_key(HEROKU_API_KEY)                         
               app = Heroku.app(HEROKU_APP_NAME)
