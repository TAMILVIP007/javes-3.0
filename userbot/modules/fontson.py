...
async def inline_id_handler(e: events.InlineQuery.Event):
    ...
    if e.query.user_id == me.id:
        ...
        await e.answer([resultm])
            #await e.delete()
    if e.query.user_id != me.id:
        resultm = builder.article(title="me not your bot",description="Mind Your Business",text="Hey U Must Use https://github.com/Sh1vam/javes-3.0  ",buttons=[[Button.switch_inline("Search Again", query="figlet ", same_peer=True)],], )
        await e.answer([resultm])
        return
